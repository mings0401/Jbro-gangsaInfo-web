...
function drawWidthMode() {
    ...
    var table = '<table class="all-width-height-100">'+
        ...
        '<img class="img-join" src="images/join/commonjoin.png">'+
        '</td>'+
        '</tr>'+
        ...
        '<td colspan="7"></td>'+
        '<td width="100px">'+
        '<font class="font-16px-subtitle">소속</font>'+
        '</td>'+
        '<td width="10px;"></td>'+
        '<td width="200px;">'+
        ...
        '<td colspan="7"></td>'+
        '<td width="100px">'+
        '<font class="font-16px-subtitle">기관명</font>'+
        '</td>'+
        '<td width="10px;"></td>'+
        '<td width="200px;">'+
        '<input type="text" class="input-text-area">'+
        ...
        '<td colspan="7"></td>'+
        '<td width="100px">'+
        '<font class="font-16px-subtitle">직급</font>'+
        '</td>'+
        '<td width="10px;"></td>'+
        '<td width="200px;">'+
        '<input type="text" class="input-text-area">'+
...
function drawHeightMode() {
    ...
    var table = '<table class="all-width-height-100">' +
        ...
        '<img style="width: '+ windowWidth * 0.3 +'px;" src="images/join/commonjoin.png">'+
        '</td>' +
        '</tr>' +
